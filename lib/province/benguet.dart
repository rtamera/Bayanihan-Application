...
class _ShowBenguetDataState extends State<ShowBenguetData> {
  ...
  void _loadCSV() async {
    final _rawData = await rootBundle.loadString("assets/res/benguet_data.csv");
                                  ...
                                  child: Column(
                                    children: <Widget>[
                                      ...
                                      Row(
                                        ...
                                        children: <Widget>[
                                          Text(
                                            _data[index+1][2].toString().toUpperCase(), //MUNICIPALITY
                                      ...
                                      SizedBox(height: 20),
                                      Text(_data[index+1][3], style: kTitleTextstyle2), //CQ STATUS
                                      SizedBox(height: 10),
