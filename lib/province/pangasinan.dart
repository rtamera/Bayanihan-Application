...
class _ShowPangasinanDataState extends State<ShowPangasinanData> {
  ...
  void _loadCSV() async {
    final _rawData = await rootBundle.loadString("assets/res/pangasinan_data.csv");
                              ...
                              child: SafeArea(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        Text(
                                          _data[index][2].toString().toUpperCase(), //MUNICIPALITY
                                    ...
                                    SizedBox(height: 20),
                                    Text(_data[index][3], style: kTitleTextstyle2), //CQ STATUS
                                    SizedBox(height: 10),
